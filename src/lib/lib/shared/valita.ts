...
export function parse<T>(value: unknown, schema: v.Type<T>, mode?: ParseOptionsMode): T {
...
export function is<T>(value: unknown, schema: v.Type<T>, mode?: ParseOptionsMode): value is T {
...
export function test<T>(value: unknown, schema: v.Type<T>, mode?: ParseOptionsMode): Result<T> {
...
export function readonlyArray<T extends v.Type>(t: T): v.Type<readonly v.Infer<T>[]> {
	return v.array(t);
}
 ...
 */
export function deepPartial<Shape extends ObjectShape>(s: v.ObjectType<Shape, undefined>) {

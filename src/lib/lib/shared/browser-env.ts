...
export function getBrowserGlobal<T extends keyof GlobalThis>(name: T): GlobalThis[T] | undefined {
...
export function mustGetBrowserGlobal<T extends keyof GlobalThis>(name: T): GlobalThis[T] {
